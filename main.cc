...
int main(int argc, char* argv[]) {
    ...
    std::string password = "userpassword";                   // Change this to whatever you want your file to be encrypted with
    ...
    while (runApp) {
        ...
        // Check if user wants to continue using the password manager
        bool validInput = false;
        while (!validInput) {
            std::cout << "\033[;34mDo you want to do anything else? (1 for yes, 2 for no)?: \033[0m";
            int choice;
            std::cin >> choice;
            ...
            if (std::cin.fail()) {
                ...
                std::cout << "" << std::endl;
                std::cout << "\033[1;31mInvalid input. Please enter 1 or 2.\033[0m" << std::endl;
            } else {
                if (choice == 1) {
                    validInput = true;
                } else if (choice == 2) {
